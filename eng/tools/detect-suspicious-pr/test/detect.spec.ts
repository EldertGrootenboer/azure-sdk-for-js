...
import type { DetectionReason, PullRequestInput } from "../src/detect.js";
...
describe("validateInput", () => {
  ...
  it.each([
    ...
    ["a number", 42],
    ["an array", [1, 2, 3]],
  ])("non-object input (%s) returns safe defaults", (_desc, value) => {
...
describe("checkCiFiles – alternative lockfile detection", () => {
  it.each(["yarn.lock", "bun.lockb", "bun.lock"])(
    "%s is flagged with lockfile message",
    (file) => {
